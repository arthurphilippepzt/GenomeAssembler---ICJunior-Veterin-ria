...
O projeto consiste em automatizar os processos desses programas que são todos usados na linha de comando, ou seja, fizemos uma interface que faz todos os processos sem que o usuário precise escrever alguma coisa no CMD.
